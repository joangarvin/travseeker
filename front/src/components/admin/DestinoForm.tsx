...
import type { AdminMunicipio, DestinoFormState } from '../../types/admin';
...
import MunicipioLinker from './MunicipioLinker';
import SeasonPicker from './SeasonPicker';

interface MunicipioLinkerProps {
...
interface Props {
  ...
  onCancel: () => void;
  municipioLinker?: MunicipioLinkerProps | null;
}
...
export default function DestinoForm({
  ...
  return (
    <div className="space-y-4 pb-24 lg:pb-4">
      ...
      <AdminSectionCard
        icon={Building2}
        title="Municipios de este destino"
        description={
          editingId
            ? 'Elige del catálogo compartido. Editar precios y conexiones se hace en la pestaña Municipios.'
            : 'Guarda primero el destino para poder añadir municipios.'
        }
      >
