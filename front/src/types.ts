...
export type CollectionDetail = CollectionSummary & {
  ...
  items: Array<{ id: string; destinoId: string; notas?: string | null; dayIndex?: number | null; status: string; destino: Destino }>;
  members?: Array<{ id: string; role: string; user: Pick<User, 'id' | 'email' | 'nombre' | 'avatarUrl'> }>;
};
